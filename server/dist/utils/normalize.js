...
function uniqueCommitIntents(commits, limit) {
...
export function summarizeRepo(repo, style) {
...
export function summarizeOverall(repositories, style) {
...
export function finalizeRepositories(repositories, style) {
    return repositories
        .map((repo) => {
