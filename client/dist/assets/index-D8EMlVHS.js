    ...
    <section class="rounded-xl border border-[#30363d] bg-[#0f141b] p-3">
      <header class="flex flex-col items-start justify-between gap-2 md:flex-row">
        <div>
          ...
          <p class="mt-1 text-xs text-slate-400">${i(`Repository: ${e.repository||"All available repositories for target"} | Commits: ${e.totalCommitCount} | Style: ${b(r.summaryStyle)} | Date: ${v(r.dateFilterMode)}`)}</p>
        </div>
